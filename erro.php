	...
	<div class="container-fluid" >
		...
		<div class="row">
			...
			<div class="erro text-center">
				...
				<h2 class="anton">Senha ou usuário incorreto!</h2>
				
				<a href="formLogon.php" class="btn btn-block btn-danger" role="button" style="margin-top:30px">Voltar</a>
                
                <div style="margin-top:15px">
                    <a href="formUser.php" >Ainda não sou cadastrado</a>							
                </div>

    ...
    <div class="col-sm-4 sombra" >
        <form method="POST" action="validates_logon.php" >
            ...
            <div class="form-group">
                <label class="anton" for="exampleInputEmail1">Email</label>
                <input type="email" name="email_user" class="form-control" required>
            </div>
            <div class="form-group">
                <label class="anton" for="exampleInputPassword1">Senha</label>
                <input type="password" name="senha_user" class="form-control" required>
            </div>
            <button type="submit" class="btn btn-primary">Entrar</button>
            <a id="register" href="formUser.php">Ainda não sou cadastrado</a>
        </form>
    </div>
</div>
</div>
